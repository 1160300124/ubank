...
<div class="body">
    <div class="zBodyK" style="box-shadow:2px 2px 10px rgba(0,0,0,.3);margin-top:30px">
		<div class="error">
        	<div class="pic error500" style="background-image:url(<%=request.getContextPath()%>/images/error500.gif)"></div>
            <div class="text">
            	<div class="text1">很遗憾！服务器繁忙，请稍后再试！！</div>
                <div class="text2">错误类型：500，服务器繁忙。</div>
