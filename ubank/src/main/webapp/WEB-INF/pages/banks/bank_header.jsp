...
<head>
    ...
    <script type="text/javascript">
        function logout(){
            window.location = "<%=request.getContextPath()%>" + "/backend_bank/bankLogout";
        }
    </script>
</head>
<body >
...
<div class="header clearfix">
    <a href="<%=request.getContextPath()%>/backend_bank/bank_index" class="logo fl"></a>
    <h1 class="fl">优发展银行</h1>
    <div class="fr header-user">
        <i class="fl icon-user-one"></i>
        <span class="fl username" >${BACKENDUSER.name }</span>
        <i class="fl icon-arrows-bottom"></i>
        <%--<ul class="header-user-menu" onclick="logout()">--%>
        <%--<li>退出</li>--%>
    <%--</ul>--%>
        <ul class="header-user-menu" >
            <li class="line" onclick="openModifyPwd()">修改密码</li>
            <li class="line" onclick="logout()">退出</li>
        </ul>
    </div>
    <span class="fr">${BACKENDUSER.bankName }</span>
</div>
<%--修改密码弹出框--%>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-inline base-form clearfix">
                    <form id="modify_form" method="post" class="form-horizontal" >
                        <div class="form-group col-md-12">
                            <label class="col-md-3" for="exampleInputName2">旧密码</label>
                            <div class="col-md-9">
                                <input type="password" class="form-control oldPwd" name=""   placeholder="请输入旧密码">
                            </div>
                        </div>
                        <div class="form-group col-md-12">
                            <label class="col-md-3" for="exampleInputName2">新密码</label>
                            <div class="col-md-9">
                                <input type="password" class="form-control newPwd" name=""   placeholder="请输入新密码">
                            </div>
                        </div>
                        <div class="form-group col-md-12">
                            <label class="col-md-3" for="exampleInputName2">确认密码</label>
                            <div class="col-md-9">
                                <input type="password" class="form-control confirmPwd"  name=""  placeholder="请再次输入密码" >
                            </div>
                        </div>
                    </form>
                </div>
