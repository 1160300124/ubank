...
<!--             <button id="btn_edit" type="button" class="btn btn-default">
		...
		<table id="tb_thirdUrls" data-toggle="table" data-url="thirdUrls" data-method="get" data-toolbar="#toolbar" data-striped="true" data-sort-order="desc"
			...
			<tr>
				...
				<th data-field="page.pageName">URL分页</th>
				<th data-field="module.moduleName">URL类别</th>
					...
					<form class="form-horizontal" role="form" id="add_form">
						...
						<div class="form-group">
	                     ...
	                     <div class="form-group">
	                        ...
	                        <div class="col-sm-5">
	                            <img src="<%=request.getContextPath()%>/images/bodyBg.jpg" class="img-thumbnail" id="img_path" alt="Cinque Terre" width="80" height="80">
	                    ...
	                    <div class="form-group">
	                       <label class="col-sm-2 control-label" for="url_page">分页</label>
	                       <div class="col-sm-5">
	                    ...
	                    <div class="form-group">
	                       <label class="col-sm-2 control-label" for="url_module">类别</label>
	                       <div class="col-sm-5">
				...
				<form class="form-horizontal" role="form" id="edit_form">
						...
						<div class="form-group">
	                     ...
	                     <div class="form-group">
	                        <label class="col-sm-2 control-label" for="pic_upload">图标上传</label>
	                        <div class="col-sm-5">
	                            <img src="<%=request.getContextPath()%>/images/bodyBg.jpg" class="img-thumbnail" id="img_path" alt="请上传图标" width="80" height="80">
	                            <input type="hidden" id="pic_path" name="pic_path"/>
	                        </div>
	                     </div>
