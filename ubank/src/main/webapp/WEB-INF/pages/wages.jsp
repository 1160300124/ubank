...
<div class="page-content">
    <%--工具栏--%>
    <div id="wages_Toolbar" class="btn-group">
    ...
    <%--数据表格--%>
    <table id="wages_table" > </table>

    <!-- 弹出框（Modal） -->
    <div id="wages_modal" class="modal fade">
...
<script src="<%=request.getContextPath()%>/js/wages.js" type="text/javascript"></script>
