...
var WagesFun = {
    ...
    com_listening : function () {
        $("#wages_modal").on('hide.bs.modal',function () {
            $('#wages_table').bootstrapTable('uncheckAll');
            $("#wages_form")[0].reset();
            $(".form-box").html("");
        });
    },
    //查询
    wagesQuery : function () {
        $("#wages_table").bootstrapTable({
            url : 'comQuery',
            method : 'post',// get,post
            toolbar : '#wages_Toolbar', // 工具栏
            ...
            columns : [
                ...
                {field : 'groupName', title : '发放时间', width: 130, align : 'left'},
                {field : 'account', title : '发放人数', width: 130, align : 'left'},
                {field : 'details', title : '发放金额', width: 130, align : 'left'},
                {field : 'companyNumber', title : '发放状态', width: 130, align : 'left'},
                {field : 'legalPerson', title : '查看', width: 130, align : 'left'}
            ]
        });
    },
    //查询参数
